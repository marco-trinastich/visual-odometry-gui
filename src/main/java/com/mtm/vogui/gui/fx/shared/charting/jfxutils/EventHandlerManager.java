...
package com.mtm.vogui.gui.fx.shared.charting.jfxutils;
 ...
 * those registrations can be activated or deactivated in a single step. It also keeps the
 * handlers from being added more than once.
 *
