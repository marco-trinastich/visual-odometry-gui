...
import static com.mtm.vogui.gui.fx.shared.charting.jfxutils.JFXUtil.*;
...
public class XYChartInfo {
    ...
    public Point2D getDataCoordinates(double x, double y) {
        Axis<Object> xAxis = (Axis<Object>) chart.getXAxis();
        Axis<Object> yAxis = (Axis<Object>) chart.getYAxis();
