...
package com.mtm.vogui.gui.swing.constants;
...
public class GuiConstants {
    // App identity strings live in models.constants.AppConstants (shared across UIs)
    ...
    // Info frame
    public final static String DASHBOARD_FRAME_TITLE = "Dashboard";
    ...
    // Control panel frame
    public final static String CONTROL_PANEL_FRAME_TITLE = "Control panel";
    // Toolbar
    ...
    // Dimensions (settings sections, all tunable). Border spacing per side inside the frame line =
    // INSET_H + PADDING_H; MARGIN is the gap from the panel edge to the rounded border.
    public final static int SETTINGS_PANEL_BORDER_MARGIN = 10;
    public final static int SETTINGS_PANEL_BORDER_INSET_V = 4;
    public final static int SETTINGS_PANEL_BORDER_INSET_H = 7;
    public final static int SETTINGS_PANEL_BORDER_PADDING_V = 10;
    public final static int SETTINGS_PANEL_BORDER_PADDING_H = 0;
    // VO content height reserves the horizontal-scrollbar band so the widest per-type panel never
    // clips and the VO section height stays constant across types.
    public final static int VO_SETTINGS_CONTENT_HEIGHT = 73;
