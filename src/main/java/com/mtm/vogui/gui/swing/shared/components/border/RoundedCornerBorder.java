...
package com.mtm.vogui.gui.swing.shared.components.border;
...
public class RoundedCornerBorder extends AbstractBorder {
    ...
    // Gap between the drawn frame line and the content, vertical/horizontal (default keeps the
    // classic look; callers such as the settings sections trim the horizontal one).
    protected int insetV = 4;
    protected int insetH = 8;

    public RoundedCornerBorder(Color baseColor, String title) {
        this(baseColor, null, title, null, null);
    }

    public RoundedCornerBorder(Color baseColor, String title, int insetV, int insetH) {
        this(baseColor, null, title, null, null);
        this.insetV = insetV;
        this.insetH = insetH;
    }
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        // Draw title
        if (this.title != null) {
            Font font = SwingUtils.defaultFont();
    ...
    public Insets getBorderInsets(Component c) {
        return new Insets(this.insetV, this.insetH, this.insetV, this.insetH);
    }

    public Insets getBorderInsets(Component c, Insets insets) {
        insets.set(this.insetV, this.insetH, this.insetV, this.insetH);
        return insets;
    }
}
