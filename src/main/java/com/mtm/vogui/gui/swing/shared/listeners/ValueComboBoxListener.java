...
import com.mtm.vogui.gui.swing.shared.components.combobox.ComboBoxItem;
import com.mtm.vogui.gui.swing.shared.components.combobox.ComboBoxSelection;
...
public final class ValueComboBoxListener<T> implements ItemListener {
    ...
    private @Nullable ComboBoxItem<T> getCurrentItem(@NotNull ItemEvent e) {
        ...
        int itemIndex = e.getStateChange() == ItemEvent.SELECTED ?
                ...
                SwingUtils.getComboBoxItemIndex(comboBox.getModel(), item);
