...
public class SettingsConstants {
    public final static String[] DEFAULT_CALIBRATION_PATHS = new String[]{
            "data/boofcv/applet/vo/drc/mono_plane.yaml",
    ...
    public final static String[] DEFAULT_VIDEO_PATHS = new String[]{
            "data/boofcv/applet/vo/drc/left_mono.mjpeg",
