...
public enum AppStatus implements WithValue {
    ...
    // Settings management
    JSONSettingsLoaded("JSON settings successfully loaded."),
    JSONSettingsNotFound("Error: JSON settings file not found."),
    JSONSettingsLoadError("Error loading JSON settings."),
    JSONSettingsSaved("JSON settings successfully saved."),
    JSONSettingsSaveError("Error saving JSON settings."),
    YAMLSettingsLoaded("YAML settings successfully loaded."),
    YAMLSettingsNotFound("Error: YAML settings file not found."),
    YAMLSettingsLoadError("Error loading YAML settings."),
    YAMLSettingsSaved("YAML settings successfully saved."),
    YAMLSettingsSaveError("Error saving YAML settings."),
